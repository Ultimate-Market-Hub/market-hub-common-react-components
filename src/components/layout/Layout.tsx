...
export default function BackofficeLayout({
  ...
  return (
    <div className="h-full">
              ...
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                ...
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                  <div className="flex h-16 shrink-0 items-center">
                    <h2 className="font-branded text-primary-hub">
                      ULTIMATE MARKET HUB
                    </h2>
                  </div>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex-col">
        {/* Sidebar component, swap this element with another sidebar if you like */}
        <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
          <div className="flex h-16 shrink-0 items-center">
            <h2 className="font-branded text-xl font-bold text-primary-hub">
              ULTIMATE MARKET HUB
            </h2>
          </div>
          {/*<nav className="flex flex-1 flex-col">*/}
      ...
      <div>
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-1 gap-x-4 lg:gap-x-6">
            <div className="flex h-full w-full items-center justify-end gap-x-4 self-end lg:gap-x-6">
              <button
                type="button"
