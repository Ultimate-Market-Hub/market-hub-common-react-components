...
export default function SimpleFullOrderDetails() {
  return (
    <main className="bg-white px-4 pb-24 pt-16 sm:px-6 sm:pt-24 lg:px-8 lg:py-32">
      <div className="mx-auto max-w-3xl">
        <div className="max-w-xl">
          <h1 className="text-base font-medium text-primary-hub-700">
            Thank you!
          </h1>
          ...
          <dl className="mt-12 text-sm font-medium">
            ...
            <dd className="mt-2 text-primary-hub-700">51547878755545848512</dd>
          </dl>
        </div>
