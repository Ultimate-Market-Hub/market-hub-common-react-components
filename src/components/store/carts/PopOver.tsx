                ...
                >
                  <Popover.Panel className="absolute inset-x-0 top-16 mt-px bg-white pb-6 shadow-lg sm:px-2 lg:left-auto lg:right-0 lg:top-full lg:-mr-1.5 lg:mt-3 lg:w-80 lg:rounded-lg lg:ring-1 lg:ring-black lg:ring-opacity-5">
                    ...
                    <form className="mx-auto max-w-2xl px-4">
                      ...
                      <button
                        type="submit"
                        className="focus:ring-primary-hub-500500 w-full rounded-md border border-transparent bg-primary-hub-700 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary-hub-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50"
                      >
                        Checkout
                      </button>
