      ...
      <main className="pb-24">
                    ...
                    {filters.price.map((option, optionIdx) => (
                      ...
                      >
                        <input
                          ...
                          type="checkbox"
                          className="focus:ring-primary-hub-500500 h-4 w-4 flex-shrink-0 rounded border-gray-300 text-primary-hub-700"
        ...
        >
          <div className="min-w-0 flex-1">
            <a
              href="#"
              className="focus:ring-primary-hub-500700 inline-flex h-10 items-center rounded-md border border-gray-300 bg-white px-4 hover:bg-gray-100 focus:border-primary-hub-700 focus:outline-none focus:ring-2 focus:ring-opacity-25 focus:ring-offset-1 focus:ring-offset-primary-hub-700"
            >
              Previous
            </a>
          </div>
          <div className="hidden space-x-2 sm:flex">
            {/* Current: "border-primary-hub-700 ring-1 ring-primary-hub-700", Default: "border-gray-300" */}
            <a
              href="#"
              className="focus:ring-primary-hub-500700 inline-flex h-10 items-center rounded-md border border-gray-300 bg-white px-4 hover:bg-gray-100 focus:border-primary-hub-700 focus:outline-none focus:ring-2 focus:ring-opacity-25 focus:ring-offset-1 focus:ring-offset-primary-hub-700"
            >
            ...
            <a
              href="#"
              className="focus:ring-primary-hub-500700 inline-flex h-10 items-center rounded-md border border-primary-hub-700 bg-white px-4 ring-1 ring-primary-hub-700 hover:bg-gray-100 focus:border-primary-hub-700 focus:outline-none focus:ring-2 focus:ring-opacity-25 focus:ring-offset-1 focus:ring-offset-primary-hub-700"
            >
              3
            </a>
