...
export default function SingleStepSidebar() {
                      ...
                      >
                        {({ checked, active }) => (
                          <>
                            ...
                            {checked ? (
                              <CheckCircleIcon
                                className="h-5 w-5 text-primary-hub-700"
                                aria-hidden="true"
                              />
                            ) : null}
                            <span
                      ...
                      <div key={paymentMethod.id} className="flex items-center">
                        {paymentMethodIdx === 0 ? (
                          <input
                            ...
                            type="radio"
                            defaultChecked
                            className="focus:ring-primary-hub-500500 h-4 w-4 border-gray-300 text-primary-hub-700"
                          />
                        ) : (
                          <input
                            id={paymentMethod.id}
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <div className="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                        ...
                        <div className="flex flex-1 items-end justify-between pt-2">
                          ...
                          <div className="ml-4">
                            ...
                            <select
                              id="quantity"
                              name="quantity"
                              className="focus:ring-primary-hub-500500 rounded-md border border-gray-300 text-left text-base font-medium text-gray-700 shadow-sm focus:border-primary-hub-500 focus:outline-none focus:ring-1 sm:text-sm"
                            >
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                  <button
                    type="submit"
                    className="focus:ring-primary-hub-500500 w-full rounded-md border border-transparent bg-primary-hub-700 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-primary-hub-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50"
                  >
                    Confirm order
                  </button>
                </div>
