          ...
          <div className="mx-auto w-full max-w-lg">
            ...
            <form className="mt-6">
              ...
              <button
                type="submit"
                disabled
                className="focus:ring-primary-hub-500500 mt-6 w-full rounded-md border border-transparent bg-primary-hub-700 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary-hub-700 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-500"
              >
                Continue
              </button>
            </form>
