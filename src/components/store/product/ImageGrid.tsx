        ...
        <div className="mx-auto max-w-2xl px-4 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <form className="mt-10">
              ...
              <button
                type="submit"
                className="focus:ring-primary-hub-500500 mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-primary-hub-700 px-8 py-3 text-base font-medium text-white hover:bg-primary-hub-700 focus:outline-none focus:ring-2 focus:ring-offset-2"
              >
                Add to bag
              </button>
            </form>
