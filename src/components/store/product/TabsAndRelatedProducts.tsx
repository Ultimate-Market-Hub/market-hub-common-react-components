...
export default function TabsAndRelatedProducts() {
  ...
  return (
    <div className="bg-white">
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-primary-hub-700 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
      ...
      <main className="mx-auto px-4 pb-24 pt-14 sm:px-6 sm:pb-32 sm:pt-16 lg:max-w-7xl lg:px-8">
        ...
        <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
          ...
          <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
              ...
              <button
                type="button"
                className="focus:ring-primary-hub-500500 flex w-full items-center justify-center rounded-md border border-transparent bg-primary-hub-50 px-8 py-3 text-base font-medium text-primary-hub-700 hover:bg-primary-hub-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50"
              >
                Preview
              </button>
            </div>
        ...
        <div className="mx-auto mt-24 max-w-2xl sm:mt-32 lg:max-w-none">
          <div className="flex items-center justify-between space-x-4">
            ...
            <a
              href="#"
              className="whitespace-nowrap text-sm font-medium text-primary-hub-700 hover:text-primary-hub-500"
            >
              View all
            ...
            <div className="mt-12 md:col-span-8 md:col-start-3 md:row-start-2 md:mt-0 lg:col-span-4 lg:col-start-9 lg:row-start-1">
              ...
              <form className="mt-3 sm:flex lg:block xl:flex">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="focus:ring-primary-hub-500500 block w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:border-primary-hub-500 focus:outline-none focus:ring-1 sm:min-w-0 sm:max-w-xs sm:flex-1 lg:max-w-none"
                />
