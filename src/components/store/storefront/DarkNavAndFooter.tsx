...
export default function DarkNavAndFooter() {
            ...
            <div className="mt-12 md:mt-16 xl:mt-0">
              ...
              <form className="mt-2 flex sm:max-w-md">
                ...
                <div className="ml-4 flex-shrink-0">
                  <button
                    type="submit"
                    className="focus:ring-primary-hub-500500 flex w-full items-center justify-center rounded-md border border-transparent bg-primary-hub-700 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-primary-hub-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900"
                  >
                    Sign up
                  </button>
                </div>
