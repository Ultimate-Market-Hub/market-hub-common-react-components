...
export default function ImageTilesFeatureSections() {
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            ...
            <div>
              <div className="mt-10">
                ...
                <a
                  href="#"
                  className="inline-block rounded-md border border-transparent bg-primary-hub-700 px-8 py-3 text-center font-medium text-white hover:bg-primary-hub-700"
                >
                  Shop Collection
                </a>
              </div>
        ...
        <section aria-labelledby="category-heading" className="bg-gray-50">
          <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
            ...
            <div className="mt-6 sm:hidden">
              <a
                href="#"
                className="block text-sm font-semibold text-primary-hub-700 hover:text-primary-hub-500"
              >
                Browse all categories
                <span aria-hidden="true"> &rarr;</span>
              </a>
            ...
            <div className="mt-16 md:mt-16 xl:mt-0">
              ...
              <form className="mt-2 flex sm:max-w-md">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="focus:ring-primary-hub-500500 w-full min-w-0 appearance-none rounded-md border border-gray-300 bg-white px-4 py-2 text-base text-primary-hub-500 placeholder-gray-500 shadow-sm focus:border-primary-hub-500 focus:outline-none focus:ring-1"
                />
