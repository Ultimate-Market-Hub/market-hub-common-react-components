...
const offers = [
  ...
  },
  {
    ...
    description: '15% off your first orderDetails',
    href: '#',
  },
];
...
const testimonials = [
  {
    id: 1,
    quote:
      'My orderDetails arrived super quickly. The product is even better than I hoped it would be. Very happy customer over here!',
  ...
  },
  {
    id: 3,
    quote:
      'Now that I’m on holiday for the summer, I’ll probably orderDetails a few more shirts. It’s just so convenient, and I know the quality will always be there.',
...
export default function OffersAndTestimonials() {
        ...
        <section aria-labelledby="trending-heading" className="bg-white">
          <div className="py-16 sm:py-24 lg:mx-auto lg:max-w-7xl lg:px-8 lg:py-32">
            <div className="flex items-center justify-between px-4 sm:px-6 lg:px-0">
              ...
              <a
                href="#"
                className="hidden text-sm font-semibold text-primary-hub-700 hover:text-primary-hub-500 sm:block"
              >
                See everything
            ...
            <div className="mt-12 px-4 sm:hidden">
              <a
                href="#"
                className="text-sm font-semibold text-primary-hub-700 hover:text-primary-hub-500"
              >
                See everything
                <span aria-hidden="true"> &rarr;</span>
              </a>
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
                ...
                <div className="mx-auto max-w-sm">
                  ...
                  <form className="mt-4 sm:mt-6 sm:flex">
                    ...
                    <div className="mt-3 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                      <button
                        type="submit"
                        className="focus:ring-primary-hub-500500 flex w-full items-center justify-center rounded-md border border-transparent bg-primary-hub-700 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-primary-hub-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white"
                      >
                        Sign up
                      </button>
                    </div>
              ...
              <div className="relative mt-6 flex items-center px-6 py-12 sm:px-10 sm:py-16 lg:mt-0">
                <div className="absolute inset-0 overflow-hidden rounded-lg">
                  ...
                  />
                  <div className="absolute inset-0 bg-primary-hub-700 bg-opacity-90" />
                </div>
